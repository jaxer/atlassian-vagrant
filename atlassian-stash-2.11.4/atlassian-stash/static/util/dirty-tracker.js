define('util/dirty-tracker', [
    ...
    var dirtyEvents = 'change input keypress keydown cut paste', //Pokemon!
        ...
        defaultSelector = 'input, textarea';

    function dirtyHandler (e){
        var nonPrintingChangeKeys = [$.ui.keyCode.BACKSPACE, $.ui.keyCode.DELETE];
        ...
        $(this)
            ...
            .off(dirtyEvents, dirtyHandler); //Unbind from the element directly to handle non-live-event tracking
    }
    ...
    exports.track = function(opts) {
        ...
        if (opts.selector || opts.container || !opts.elements) {
            ...
            var $container = $(opts.container || defaultContainer),
                selector = opts.selector || defaultSelector;
