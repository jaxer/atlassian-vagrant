define('widget/confirm-dialog', [
    ...
    ConfirmDialog.dialogDefaults = {
        id: undefined,
        titleText: stash_i18n('stash.web.title.confirm', 'Confirm'),
        titleClass: 'confirm-header',
        confirmButtonClass: 'confirm-button',
        panelContent: '<p>' + stash_i18n('stash.web.dialog.confirm', 'Are you sure you want to do that?') + '</p>',
        panelClass: 'panel-body',
        submitText: stash_i18n('stash.web.button.confirm', 'Confirm'),
        submitToHref: true,
        height: 230,
        width: 433,
